...
\begin{titlepage}
\begin{center}
{\fontsize{28}{34}\selectfont\bfseries Field Oriented Control (FOC) for a 3-Phase Induction Motor\par}
\vspace{1.5cm}
{\fontsize{14}{17}\selectfont \textit{Project Report Submitted in partial fulfilment of the requirements for the degree of Bachelor of Technology from Maulana Abul Kalam Azad University of Technology, West Bengal (formerly known as West Bengal University of Technology)}\par}
\vspace{1.5cm}
...
JIBITESH BASUNIA (Roll No. 34901622045)\par}


\vspace{1.5cm}
{\fontsize{16}{19}\selectfont \textit{Under the Guidance of}\par}
\vspace{0.5cm}
{\fontsize{16}{19}\selectfont Prof. Deepjyoti Santra\par}
\vfill
{\Large \textbf{Department of Electrical Engineering}\par}
{\Large \textbf{Cooch Behar Government Engineering College}\par}
{\Large \textbf{Cooch Behar, West Bengal}\par}
...
\end{center}
\vspace{1cm}
It is hereby recommended to consider the project report entitled \textbf{``Field Oriented Control (FOC) for a 3-Phase Induction Motor''} submitted by SURJA MONDAL (Roll No. 34901622011), JOYDIP KARMAKAR (Roll No. 34901622014), ANGSU PRIYA ROY (Roll No. 34901622020), HIRAK SINHA (Roll No. 34901622042), KESHAB SARKAR (Roll No. 34901622044) and JIBITESH BASUNIA (Roll No. 34901622045) for partial fulfillment of the requirements for the award of the degree of Bachelor of Technology in Electrical Engineering from Maulana Abul Kalam Azad University of Technology (formerly known as West Bengal University of Technology).
\vspace{3cm}
...
\end{center}
\vspace{1cm}
It is hereby approved that the project report entitled \textbf{``Field Oriented Control (FOC) for a 3-Phase Induction Motor''} submitted by SURJA MONDAL (Roll No. 34901622011), JOYDIP KARMAKAR (Roll No. 34901622014), ANGSU PRIYA ROY (Roll No. 34901622020), HIRAK SINHA (Roll No. 34901622042), KESHAB SARKAR (Roll No. 34901622044) and JIBITESH BASUNIA (Roll No. 34901622045) for partial fulfilment of the requirements for the award of the degree of Bachelor of Technology in Electrical Engineering from Maulana Abul Kalam Azad University of Technology (formerly known as West Bengal University of Technology).
\vspace{3cm}
...
% --- TOC, LOF, LOT ---
% LaTeX will automatically generate these when compiled twice.
\newpage
\tableofcontents
\newpage
\listoffigures
...
\begin{figure}[H]
    ...
    \caption{Detailed Implementation of the FOC Control Loops (Current and Flux Regulation)}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{VECTOR_CONTROL_FOC_OF_IM-16.png}
    \caption{Reference Signal Builder Logic}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Simulink Subsystem: Transformation to Magnitude ($V_{ref}$) and Angle}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{VECTOR_CONTROL_FOC_OF_IM-15.png}
    \caption{Simulink Subsystem: Angle Normalization (rad to deg)}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Scope Output: Calculated High-Frequency Dwell Times ($T_0, T_1, T_2$)}
\end{figure}

\subsection{Switching Sequence Generation}
The calculated dwell times are mapped to logical duty cycle values ($F_1, F_2, F_3, F_4$) via a multiport switch governed by the sector number $n$, which are then compared against a high-frequency triangular carrier to generate physical Boolean pulses ($V_{g1}$ to $V_{g6}$) for the IGBT drivers. A symmetrical switching pattern is employed.
...
\begin{figure}[H]
    ...
    \caption{Scope Output: Duty Cycles of the High-Side Inverter Switches S1, S3, S5}
\end{figure}
...
\bibitem{bose}
B. K. Bose, \emph{Modern Power Electronics and AC Drives}. Prentice Hall PTR, 2001.

\bibitem{novotny}
D. W. Novotny and T. A. Lipo, \emph{Vector Control and Dynamics of AC Drives}. Oxford University Press, 1996.

\bibitem{krishnan}
R. Krishnan, \emph{Electric Motor Drives: Modeling, Analysis, and Control}. Prentice Hall, 2001.

\bibitem{kazmierkowski}
D. C. White, T. A. Lipo, and M. P. Kazmierkowski, \emph{High Performance Control of AC Drives with Matlab / Simulink Models}. Wiley, 2012.

\bibitem{simulink}
MathWorks, ``Simulink Documentation - Modeling and Simulating Dynamic Systems,'' 2023. [Online]. Available: https://www.mathworks.com/help/simulink/
